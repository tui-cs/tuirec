...
tuirec is a pipeline tool. Each stage (PTY → recorder → keystroke player → GIF renderer) does one thing well. Complexity belongs in the orchestration, not in the components.
