...
2. ~~Whether to bundle `agg` or require it~~ — **Resolved:** require it; pin the sixel-capable fork `tig/agg v1.11.0-sixel` (see `spec.md` Decisions). Release archives bundle it; source builds auto-download or use `--agg-path`.
